...
rulesdata = [
    ...
    """,
    {
        ...
        subscribe_to: [
            ...
            "validate-serviceconfigurationprovider-create",
            "validate-serviceconfigurationprovider-update",
            "validate-serviceconfigurationprovider-delete",
            "validate-featureconfigurationprovider-create",
            "validate-featureconfigurationprovider-update",
            "validate-featureconfigurationprovider-delete",
